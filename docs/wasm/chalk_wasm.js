...
export class MathParser {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        MathParserFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_mathparser_free(ptr, 0);
    }
    /**
     * Creates a new Math Parser
     */
    constructor() {
        const ret = wasm.mathparser_new();
    ...
    eval(expression) {
        ...
        try {
            ...
            const ret = wasm.mathparser_eval(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('chalk_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
